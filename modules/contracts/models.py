...
class Contract(models.Model):
    ...
    date_create = models.DateField(blank=False, verbose_name='Дата создания договора')
    date_signet = models.DateField(blank=True, null=True, verbose_name='Дата подписания договора')
    date_begin = models.DateField(blank=True, null=True, verbose_name='Дата начала ответственности')
    date_end = models.DateField(blank=True, null=True, verbose_name='Дата окончания ответственности')
